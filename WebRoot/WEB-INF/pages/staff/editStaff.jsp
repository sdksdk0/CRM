	...
	<table width="88%" border="0" class="emp_table" style="width:80%;">
	 ...
	 <tr>
	    ...
	    <td width="62%">
	    	...
	    	<s:select list="#allPost" name="crmPost.postId"    id="postSelectId" 
	   ...
	   <tr>
	    <td width="10%">入职时间：</td>
	    <td width="20%">
	    	<s:date name='onDutyDate' format='yyyy-MM-dd' var="myEndTime" />
	    	<s:textfield name="onDutyDate"  readonly="true" onfocus="c.showMoreDay=true; c.show(this);" value="%{#myEndTime}"></s:textfield>
	    </td>
	    <td width="8%"></td>
	    <td width="62%"></td>
	  </tr>
